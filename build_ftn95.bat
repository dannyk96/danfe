...
%FC_CPP% libsrc\int_gen.F90 /BINARY int_gen.obj
...
%FC% src\danmung.f    /LINK danmung.exe  /LIBRARY %DANLIB% %MPILIB% 
...
%FC% src\danplot.f    /LINK danplot.exe  /LIBRARY %DANLIB% %DANLIBJ% int_gen.obj %MPILIB%
